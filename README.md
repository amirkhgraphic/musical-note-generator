...
1. **Clone the Repository**:
   ```bash
   git clone https://github.com/amirkhgraphic/musical-note-generator.git
...
4. **Apply Migrations**:
   ```bash
   python manage.py makemigrations users music
...
### Email Backend
For development purposes, emails are displayed in the console (the terminal where you enter runserver command).
```python
...
```
Enter username, email and password to finish creating superuser!
...
### Genetic Algorithm
The genetic algorithm implementation can be found in the `utils/algorithms/` module. Key features include:
- Fitness calculation
